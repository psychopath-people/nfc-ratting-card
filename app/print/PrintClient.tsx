      ...
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1 leading-relaxed">
            Generate ID kartu baru dan QR code-nya. Tulis NFC per chip, lalu print.
          </p>
        </div>
        ...
        <div className="space-y-5">
          ...
          <div className="border border-gray-100 rounded-lg p-4 space-y-1.5">
            <p className="text-xs font-medium text-gray-600">Yang akan terjadi:</p>
            <ul className="text-xs text-gray-400 space-y-1">
              <li>{quantity} ID kartu unik dibuat otomatis</li>
              <li>QR code tiap kartu di-generate</li>
              <li>Tersimpan di database sebagai belum aktif</li>
              <li>Preview siap untuk tulis NFC dan print</li>
            </ul>
          </div>
